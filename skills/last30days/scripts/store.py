#!/usr/bin/env python3
"""SQLite research accumulator for spark-journal.
...
Database location: ~/.local/share/spark-journal/research.db
"""
...
DB_DIR = Path.home() / ".local" / "share" / "spark-journal"
...
def main():
    parser = argparse.ArgumentParser(description="Query the spark-journal research database")
